...
#legend
set key at graph 0.5,0.08 horizontal samplen 0.2
set label 1 "MariaDB-5.3.6" at graph 0.43,0.1 left rotate by 90 front
set label 2 "MySQL-5.6.4" at graph 0.46,0.1 left rotate by 90 front
set label 3 "MySQL-5.5.21" at graph 0.49,0.1 left rotate by 90 front
