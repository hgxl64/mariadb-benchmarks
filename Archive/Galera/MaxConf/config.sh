...
# workload settings
#
WORKLOADS="90_10@rwsplit1 90_10@rwsplit2 90_10@rwsplit3 90_10@rwsplit4 read_write@rwsplit1 read_write@rwsplit2 read_write@rwsplit3 read_write@rwsplit4 50_50@rwsplit1 50_50@rwsplit2 50_50@rwsplit3 50_50@rwsplit4"
...
declare -A CONNECTION=(
  ...
  [rwsplit3]="--mysql-host=10.10.0.167 --mysql-port=6612" #LEAST ROUTER CONNECTIONS
  [rwsplit4]="--mysql-host=10.10.0.167 --mysql-port=6613" #adaptive routing
)
