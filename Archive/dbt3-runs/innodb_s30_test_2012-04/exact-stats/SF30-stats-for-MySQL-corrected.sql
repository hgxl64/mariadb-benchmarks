...
UPDATE mysql.innodb_index_stats SET stat_value=12, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='customer'
...
UPDATE mysql.innodb_index_stats SET stat_value=22500000, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='lineitem'
                        AND index_name='PRIMARY' AND stat_name='n_diff_pfx01';
...
UPDATE mysql.innodb_index_stats SET stat_value=1233, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='lineitem'
...
UPDATE mysql.innodb_index_stats SET stat_value=3000000, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='lineitem'
                        AND index_name='i_l_partkey' AND stat_name='n_diff_pfx01';
UPDATE mysql.innodb_index_stats SET stat_value=1277, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='lineitem'
                        AND index_name='i_l_receiptdate' AND stat_name='n_diff_pfx01';
UPDATE mysql.innodb_index_stats SET stat_value=1263, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='lineitem'
                        AND index_name='i_l_shipdate' AND stat_name='n_diff_pfx01';
UPDATE mysql.innodb_index_stats SET stat_value=150000, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='lineitem'
                        AND index_name='i_l_suppkey' AND stat_name='n_diff_pfx01';
UPDATE mysql.innodb_index_stats SET stat_value=3000000, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='lineitem'
                        AND index_name='i_l_suppkey_partkey' AND stat_name='n_diff_pfx01';
UPDATE mysql.innodb_index_stats SET stat_value=11995094, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='lineitem'
...
UPDATE mysql.innodb_index_stats SET stat_value=25, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='nation'
                        AND index_name='PRIMARY' AND stat_name='n_diff_pfx01';
UPDATE mysql.innodb_index_stats SET stat_value=2, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='nation'
...
UPDATE mysql.innodb_index_stats SET stat_value=45000000, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='orders'
                        AND index_name='PRIMARY' AND stat_name='n_diff_pfx01';
UPDATE mysql.innodb_index_stats SET stat_value=1499965, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='orders'
                        AND index_name='i_o_custkey' AND stat_name='n_diff_pfx01';
UPDATE mysql.innodb_index_stats SET stat_value=1203, last_update=NOW()
                        WHERE database_name='dbt3' AND table_name='orders'
