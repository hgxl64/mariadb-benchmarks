...
echo > ${AUDIT_SQL} <<EOT
INSERT INTO mysql.server_audit_filters VALUES ('default', '{"logging": "OFF"}');
INSERT INTO mysql.server_audit_filters VALUES ('log_dml', '{"connect_event":"ALL","query_event":["DML","DDL","DCL","QUERY_DML_NO_SELECT"],"table_event":["WRITE","CREATE","DROP","RENAME","ALTER"]}');
