...
export TABLES=1
export ROWS=20000000
export LUA_PREPARE=rt_read_write.lua
export LUA_ARGS_PREPARE="--bulk-load=true"
export LUA_RUN=oltp_214476.lua
export LUA_ARGS_RUN="--rand-type=uniform --ins1=3 --ins2=3 --batch_size=1000"
export THREADS=8
export RUNTIME=7200
export REPORT=5
