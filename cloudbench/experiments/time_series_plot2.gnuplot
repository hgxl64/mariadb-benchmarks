...
set output sprintf("timeseries_cluster.100.comparison.pdf")
...
set output sprintf("timeseries_cluster.110.comparison.pdf")
...
set output sprintf("timeseries_cluster.full.comparison.pdf")
